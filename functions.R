...
#' @param TP_SYP The list of true positive proteins for SYP. Ensure that the column name is gene_name.
...
#' @export
TP_FP <- function(data, sample, TP, FP, gene_name, ratio, TP_flag) {
